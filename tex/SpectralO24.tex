...
\begin{document}
  ...
  \begin{abstract}
    O18 established the minimal fibre condition: Born--Infeld parity is the
    ...
    and O23 derived the threshold condition $\Sigma_c(n_3) = 3$ from the
    ...
    As a corollary, the fibre-structure conditionality in the
    $\cchi \to \dpair$ segment is closed: its observable rank is
    independent of fibre cardinality.
  ...
  \section{Position of the Problem after O22--O23}
    ...
    \subsection{The two levels of $\Pi$: kernel and image}
      ...
      threshold condition $\Sigma_c(n_3) = 3$.
  ...
  \subsection{Fibre-structure closure and transfer boundary}
    ...
    \begin{corollary}[Fibre-structure closure for $\cchi \to \dpair$]
      ...
      of $\SBI$ --- is resolved with respect to this fibre-side result:
    ...
    \begin{proof}
      ...
      These two conditions are therefore satisfied unconditionally with respect to fibre
      structure, proving the stated rank stability.
  ...
  \subsection{What O24 closes and what it does not}
    ...
    The present paper closes the last fibre-structure conditionality in the
    $\cchi \to \dpair$ segment.
    Three fibre-side problems identified across O21--O23 are resolved:
  ...
  O22, O23, and the present paper close the named fibre-structure conditionalities.
