...
\begin{document}
  ...
  \begin{abstract}
    O18 establishes Born--Infeld parity as an equivariant symmetry of $\SBI[\chi]$ and states
  ...
  \section{Position of the Problem after O22--O23}
    ...
    \subsection{What O18 leaves open and what the mechanism requires}
      ...
      equivariant symmetry of every Born--Infeld response (O18 Proposition~2.6).
  ...
  \section{The Verticality Lemma}
    ...
    \subsection{Case analysis}
      ...
      \paragraph{Case 1: Parity $\chi \mapsto -\chi$.}
        This is the equivariant symmetry established in O18~\cite{Beau2026a22}
